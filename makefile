...
release:
	./release.sh
	gcc -Wall -Werror -Wpedantic -DEVAL -std=gnu11 -O2 -pipe -static -s -lm __Ruzza_Autostrada_API_20-07-2023.c -o main
...
valgrind:
	rm ./callgrind.*
	./release.sh
	gcc -Wall -Werror -Wpedantic -DEVAL -std=gnu11 -O2 -pipe -static -g -lm __Ruzza_Autostrada_API_20-07-2023.c -o main
